...
declare type FunctionOrComponentClass = React$Component<*, *, *> | Function;
declare module 'react-addons-test-utils' {
  ...
  declare function mockComponent(componentClass: FunctionOrComponentClass, mockTagName?: string): Object;
  declare function isElement(element: React$Element<*>): boolean;
  declare function isElementOfType(element: React$Element<*>, componentClass: FunctionOrComponentClass): boolean;
  ...
  declare function isCompositeComponentWithType(instance: React$Component<*, *, *>, componentClass: FunctionOrComponentClass): boolean;
  ...
  declare function scryRenderedComponentsWithType(tree: React$Component<*, *, *>, componentClass: FunctionOrComponentClass): Array<React$Component<*, *, *>>;
  declare function findRenderedComponentWithType(tree: React$Component<*, *, *>, componentClass: FunctionOrComponentClass): React$Component<*, *, *>;
