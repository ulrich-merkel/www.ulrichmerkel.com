 ...
 * @static
 * @type {Object}
 * @see PageDisclaimer.propTypes
 */
PageDisclaimer.defaultProps = {
    content: {}
};

export default addPageTracking(addContent('PageDisclaimer')(PageDisclaimer));
